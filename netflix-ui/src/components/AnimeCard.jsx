...
export default function AnimeCard({
  ...
  return (
    ...
    >
      <div className="cards">
        <img className="cards__img" src={`${animedata.image}`} alt="Animes" />

        <div className="cards__overlay">
          <div className="card__title">{animedata.name}</div>
        </div>
      </div>
      ...
      <div
        ...
        style={{
          visibility: `${
            isHovered === true && index !== right ? "visible" : "hidden"
          } `,
          opacity: `${isHovered === true && index !== right ? "1" : "0"}`,
        }}
      >
        {
          <>
            ...
            <div className="info-container flex column">
              ...
              <div className="data flex">
                <span className="matchscore">{animedata.score}% Match</span>
                <div className="second-line">
                  <span className="mRating">
                    {/* <span> {animedata.adult}</span> */}
                  </span>
                  <span className="duration">{animedata.length}</span>
...
const Container = styled.div`
  ...
  &.hovered {
    ...
    &.rght:before {
      content: "please slide to view this";
      position: absolute;
      top: -30px;
      left: -100px;
    }
